...
public class ScheduleRequest {
	...
	@ApiModelProperty(value = "departureHour", required = true, notes = "The starting hour of the destination", example = "10:00", position = 1)
	@JsonFormat(pattern = "HH:mm")
	private LocalTime startingHour;

	@NotNull(message = "Ending hour cannot be null")
	@ApiModelProperty(value = "landingHour", required = true, notes = "The ending hour of the destination", example = "12:00", position = 2)
	@JsonFormat(pattern = "HH:mm")
	private LocalTime endingHour;

	@NotNull(message = "Date cannot be null")
	@ApiModelProperty(value = "date", required = true, notes = "The date of the flight", example = "05-07-2023", position = 3)
